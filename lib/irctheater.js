...
exports.getTheater = function(){
    return {
        ...
        setup: function(config, clb, doneClb){
            ...
            this.welcomeMessage = this.config.welcomeMessage || 'Welcome to the Wandercircus http://wandercircus.com (say "' + this.stopShowMessage + '" to cancel this)';
            this.goodbyeMessage = this.config.goodbyeMessage || "Thank you! Visit the Wandercircus at http://wandercircus.com";
            ...
            this.director.addListener('connect', function() {
                that.director.join(that.config.irc.channel, function() {
                    that.director.say(that.config.irc.channel, that.welcomeMessage);
        ...
        tearDown: function() {
            ...
            this.director.say(this.config.irc.channel, this.goodbyeMessage);
            _(this.actors).chain()
                .values()
